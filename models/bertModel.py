...
####################### BETA ANALYTICS ###############################################
    ...
    FYI- this does nothing right now. Intended to stop training when a certain std_dev threshold is achieved over multiple epochs (ie to stop when it starts stalling/overfitting)
...
#save model we just trained and give it a version. 
